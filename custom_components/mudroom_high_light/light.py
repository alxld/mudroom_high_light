...
light_entity = "light.mudroom_high_group"
# harmony_entity = "remote.theater_harmony_hub"
# switch_action = "zigbee2mqtt/Theater Switch/action"
motion_sensor_action = "zigbee2mqtt/Mudroom High Motion Sensor"
motion_sensor_action2 = "zigbee2mqtt/Mudroom Low Motion Sensor"
motion_sensor_action3 = "zigbee2mqtt/Theater Stairs Motion Sensor"
brightness_step = 43
...
async def async_setup_platform(
    ...
    @callback
    async def motion_sensor_message_received3(
        topic: str, payload: str, qos: int
    ) -> None:
        """A new motion sensor MQTT message has been received"""
        await ent.motion_sensor_message_received3(topic, json.loads(payload), qos)
    ...
    if has_motion_sensor:
        ...
        await hass.components.mqtt.async_subscribe(
            motion_sensor_action3, motion_sensor_message_received3
        )


class MudroomHighLight(LightEntity):
    """Mudroom High Light."""

    def __init__(self) -> None:
        """Initialize Mudroom High Light."""
        self._light = light_entity
        self._name = "Mudroom High"
        # self._state = 'off'
        self._brightness = 0
    ...
    async def motion_sensor_message_received(
        ...
        if self._occupancy:
            ...
            if self._occupancy2 == False and self._occupancy3 == False:
    ...
    async def motion_sensor_message_received2(
        ...
        if self._occupancy2:
            ...
            if self._occupancy == False and self._occupancy3 == False:
                await self.async_turn_off()
    ...
    async def motion_sensor_message_received3(
        ...
        """A new MQTT message has been received."""
        if self._occupancy3 == payload["occupancy"]:
            # No change to state
            return

        self._occupancy3 = payload["occupancy"]
